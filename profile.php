    ...
    <div>
        ...
        <div class="container">
            <div class="field">
                ...
                <div class="data"><?= $_SESSION['curr-user']['first_name'] ?></div>
            </div>
            <div class="field">
                <div class="label">Nama Tengah</div>
                <div class="data"><?= $_SESSION['curr-user']['middle_name'] ?></div>
            </div>
            <div class="field">
                <div class="label">Nama Belakang</div>
                <div class="data"><?= $_SESSION['curr-user']['last_name'] ?></div>
            </div>
            <div class="field">
                <div class="label">Tempat Lahir</div>
                <div class="data"><?= $_SESSION['curr-user']['pob'] ?></div>
            </div>
            <div class="field">
                <div class="label">Tgl Lahir</div>
                <div class="data"><?= $_SESSION['curr-user']['dob'] ?></div>
            </div>
            <div class="field">
                <div class="label">NIK</div>
                <div class="data"><?= $_SESSION['curr-user']['nik'] ?></div>
            </div>
            <div class="field">
                <div class="label">Warga Negara</div>
                <div class="data"><?= $_SESSION['curr-user']['ctz'] ?></div>
            </div>
            <div class="field">
                <div class="label">Email</div>
                <div class="data"><?= $_SESSION['curr-user']['email'] ?></div>
            </div>
            <div class="field">
                <div class="label">No HP</div>
                <div class="data"><?= $_SESSION['curr-user']['phone'] ?></div>
            </div>
            <div class="field">
                <div class="label">Alamat</div>
                <div class="data"><?= $_SESSION['curr-user']['address'] ?></div>
            </div>
            <div class="field">
                <div class="label">Kode Pos</div>
                <div class="data"><?= $_SESSION['curr-user']['postal_code'] ?></div>
            </div>
            <div class="field">
                <div class="label">Foto Profil</div>
                <img src="<?= $_SESSION['curr-user']['profile'] ?>" alt="profile picture">
            </div>

            <a href="editProfile.php" id="edit-btn">
                <span class="material-icons-round edit">edit</span>Edit Profile
            </a>
        </div>
    </div>
